 ...
 * Creates floating gradient blobs that animate in the background
 * Adds visual depth and premium feel to the page
 */
export default function AnimatedBackground({ variant = 'default' }) {
    // Success page uses green tones, default uses blue
    const isSuccess = variant === 'success';

    return (
        <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden" aria-hidden="true">
            {/* Primary blob - top left, larger */}
            ...
            {/* Secondary blob - bottom right, animates in reverse */}
            ...
            {/* Tertiary blob - only on default variant for extra depth */}
            {!isSuccess && (
